   ...
   >
      <div class="p-6 text-center">
         ...
         <div :class="[`${descriptionWrapperClass}`]" class="text-center mt-5">
            <div class="text-gray-900 text-lg font-kanit-semibold mb-1">{{ title || "-" }}</div>
         ...
         <div :class="[`${buttonWrapperClass}`]" class="mt-8 flex justify-between flex-wrap gap-y-3">
            <UButton
               ...
               color="white"
               variant="solid"
               :label="labelCancel || $t('close')"
               block
               class="rounded-lg w-full sm:w-[170px] border border-gray-100 outline-none text-white"
