<template>
    <UFormGroup :label="label" :name="name" :error="error">
        <template #default="{ error }">
            <UTextarea v-if="!isView" v-model="internalValue" :value="value ? value : modelValue" color="search" size="md"
                :variant="disabled ? 'none' : 'outline'"  :placeholder="placeholder" :disabled="disabled"
